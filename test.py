...
from basicsr.models.archs.restormer_arch_SKFF_taylor_refine_DCN import Restormer
...
parser.add_argument('--weights', default='/home/qiuyuwei/Restormer-main/experiments/MP-taylor-7M(3)-lr1/models/net_g_468000.pth'
                                         , type=str, help='Path to weights')

args = parser.parse_args()

####### Load yaml #######
yaml_file = '/home/qiuyuwei/Restormer-main/Deraining/Options/Dehazing_su_refine_skff_DCN_clamp3.yml'
import yaml
